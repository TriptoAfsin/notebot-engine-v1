...
let sss1_lab_flow = [
    grroupedButtonBlockGen("⚡ All Combined -", [
        webBtnBlockGen("Hashibul(2025)", "https://drive.google.com/file/d/1ZOmIEOTbjsWVrQCkU3KXFrgd_ecklGtZ/view?usp=sharing"),
        webBtnBlockGen("Mridul(2025)", "https://drive.google.com/file/d/1p94aeElV-IAPWwxScOSqpKjUdrEjFfcr/view?usp=sharing"),
    ]),
    grroupedButtonBlockGen("⚡ All Combined -", [
